        ...
        <>
            <Container>
                <div>
                    ...
                    <div>At Blogs, accessible from localhost:3000, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Blogs and how we use it.</div>
                    ...
                    <div>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Blogs. This policy is not applicable to any information collected offline or via channels other than this website.</div>
                    <Header as='h2'>Consent</Header>
                    <div>By using our website, you hereby consent to our Privacy Policy and agree to its terms. For our Terms and Conditions, please visit the <Link to='/terms'>Terms & Conditions</Link></div>
                    ...
                    <div className="ui bulleted list">
                        <List.Item>
                            <List.Content>
                                <div className='item'>Provide, operate, and maintain our website</div>
                            </List.Content>
                        </List.Item>
                        <List.Item>
                            <List.Content>
                                <div className='item'>Improve, personalize, and expand our website</div>
                            </List.Content>
                        </List.Item>
                        <List.Item>
                            <List.Content>
                                <div className='item'>Understand and analyze how you use our website</div>
                            </List.Content>
                        </List.Item>
                        <List.Item>
                            <List.Content>
                                <div className='item'>Develop new products, services, features, and functionality</div>
                            </List.Content>
                        </List.Item>
                        <List.Item>
                            <List.Content>
                                <div className='item'>Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the webste, and for marketing and promotional purposes</div>
                            </List.Content>
                        </List.Item>
                        <List.Item>
                            <List.Content>
                                <div className='item'>Send you emails</div>
                            </List.Content>
                        </List.Item>
                        <List.Item>
                            <List.Content>
                                <div className='item'>Find and prevent fraud</div>
                            </List.Content>
                        </List.Item>
                    </div>
                    <Header as='h2'>Log Files</Header>
                    <div>Blogs follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</div>
                    <Header as='h2'>Cookies and Web Beacons</Header>
                    <div>Like any other website, Blogs uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</div>
                    <div>For more general information on cookies, please read <Link to="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies" from Cookie Consent</Link></div>
                    <Header as='h2'>Advertising Partners Privacy Policies</Header>
                    <div>You may consult this list to find the Privacy Policy for each of the advertising partners of Blogs.</div>
                    <div>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Blogs, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</div>
                    <div>Note that Blogs has no access to or control over these cookies that are used by third-party advertisers.</div>
                    <Header as='h2'>Third Party Privacy Policies</Header>
                    <div>Blogs's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </div>
                    ...
                    <Header as='h2'>CCPA Privacy Rights (Do Not Sell My Personal Information)</Header>
                    ...
                    <Header as='h2'>GDPR Data Protection Rights</Header>
                    ...
                    <div>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</div>
                    <Header as='h2'>Children's Information</Header>
